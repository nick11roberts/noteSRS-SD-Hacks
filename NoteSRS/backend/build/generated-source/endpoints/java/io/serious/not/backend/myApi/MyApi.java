...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class CorrectText extends MyApiRequest<io.serious.not.backend.myApi.model.StringWrapper> {
    ...
    protected CorrectText(java.lang.String input) {
      super(MyApi.this, "POST", REST_PATH, null, io.serious.not.backend.myApi.model.StringWrapper.class);
  ...
  public class InsertAutoCucumberListItem extends MyApiRequest<io.serious.not.backend.myApi.model.StringWrapper> {
