 ...
 * on 2015-10-03 at 21:15:00 UTC 
 * Modify at your own risk.
 */

package io.serious.not.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class CorrectText extends MyApiRequest<io.serious.not.backend.myApi.model.MyBean> {
    ...
    protected CorrectText(java.lang.String input) {
      super(MyApi.this, "POST", REST_PATH, null, io.serious.not.backend.myApi.model.MyBean.class);
  ...
  public class InsertAutoCucumberListItem extends MyApiRequest<io.serious.not.backend.myApi.model.MyBean> {

    private static final String REST_PATH = "mybean/{word}/{correction}";
